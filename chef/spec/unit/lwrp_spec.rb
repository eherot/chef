...
Dir[File.join(File.dirname(__FILE__), "..", "data", "lwrp", "resources", "*")].each do |file|
  Chef::Resource::Base.build_from_file("lwrp", file)
end

Dir[File.join(File.dirname(__FILE__), "..", "data", "lwrp", "providers", "*")].each do |file|
  Chef::Provider::Base.build_from_file("lwrp", file)
end
...
describe Chef::Resource do
  ...
  it "should create a method for each attribute" do
    Chef::Resource::LwrpFoo.new("blah").should respond_to :monkey
  end
...
describe Chef::Provider do
  ...
  it "should create a method for each attribute" do
    ...
    Chef::Provider::LwrpBuckPasser.new(nil, new_resource).should respond_to :action_pass_buck
    Chef::Provider::LwrpThumbTwiddler.new(nil, new_resource).should respond_to :action_twiddle_thumbs
  end
